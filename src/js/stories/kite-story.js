...
const chapterOne = Chapter(chp_1, chapterOneImages, qs_1, 1);
const chapterTwo = Chapter(chp_2, chapterTwoImages, qs_2, 2);
const chapterThree = Chapter(chp_3, chapterThreeImages, qs_3, 3);
const chapterFour = Chapter(chp_4, chapterFourImages, qs_4, 4);
const chapterFive = Chapter(chp_5, chapterFiveImages, qs_5, 5);
